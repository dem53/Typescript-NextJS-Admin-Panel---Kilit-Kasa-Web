...
export const PageHeader: React.FC<IPageHeaderProps> = ({ title, titleColor, subTitleColor, subTitle, count, icon, backGround, backGroundColor }) => {
    return (
        <section
            ...
            <div className="flex flex-col absolute h-full  transform mr-8  top-4 right-1  items-start justify-center  gap-1">
                <div className="top-4 drop-shadow-2xl  border-gray-300 rounded-full opacity-25 drop-shadow-black lg:top-4 ">
                    {icon}
                </div>
            ...
            <div className="w-full  h-full flex flex-row p-0 lg:p-2 items-center mt-10 justify-between">
